...
class Bot:
    ...
    def help(self, update, context):
        ...
        update.message.reply_text('Я вижу, вам нужна информация?\n1.Нажмите "WIKI" и сообщите'
                                  ' мне то, что вы хотите найти (можете использовать кнопки'
                                  ' "Больше картинок" для вывода дополнительных изображений и'
                                  ' "Получить url" для получения адреса статьи)\n2.Нажмите '
                                  '"YANDEX MAP" и сообщите мне место, которое вы хотите получить,'
                                  ' я же выведу вам карту с этим местом (можете использовать кнопки'
                                  ' "Спутник" и "Гибрид", чтобы изменить тип карты на'
                                  ' соответствующий)\n3.Нажмите TRANSLITIRATION и передайте мне'
                                  ' текст, раскладку которого хотите поменять\n4.Нажмите'
                                  ' "Создать статью" и следуйте инструкциям, чтобы создать '
                                  'статью\n5.Нажмите "Удалить статью" и выберите свою статью в '
                                  'списке, чтобы удалить статью\n6.Нажмите "Изменить статью" и'
                                  ' следуйте инструкциям, чтобы изменить статью\n7.Нажмите "Статьи"'
                                  ' и следуйте иснткруциям, чтобы просмотреть свои и чужие статьи\n'
                                  '8. Нажмите "Вывести статистику", чтобы посмотреть ее!\n'
                                  '9.Нажмите "/help", чтобы получить эту информацию'
                                  ' снова!\n10.Нажмите "/stop", чтобы выключить меня:(\n'
                                  'Желаю удачи!',
                                  reply_markup=self.markup_start)
        return 1
