...
## Заключение
Бот работает полностью исправно без каких-либо нарекай. Имеется достаточное количество функций для комфортной работы. К тому же имеется большое количество возможностей для последующего улучшения бота с малым количеством рамок и ограничений. Сам же код имеет все признаки хорошего кода:
